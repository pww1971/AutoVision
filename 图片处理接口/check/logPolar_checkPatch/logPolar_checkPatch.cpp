// logPolar_checkPatch.cpp: 定义 DLL 的初始化例程。
//
...
BEGIN_MESSAGE_MAP(ClogPolarcheckPatchApp, CWinApp)
END_MESSAGE_MAP()


// ClogPolarcheckPatchApp 构造

ClogPolarcheckPatchApp::ClogPolarcheckPatchApp()
{
	// TODO:  在此处添加构造代码，
...
// 唯一的 ClogPolarcheckPatchApp 对象

ClogPolarcheckPatchApp theApp;


// ClogPolarcheckPatchApp 初始化

BOOL ClogPolarcheckPatchApp::InitInstance()
{
