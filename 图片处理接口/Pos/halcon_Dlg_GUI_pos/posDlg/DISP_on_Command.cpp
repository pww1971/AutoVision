...
*/
		...
		int hv_width = (*om)[CST_PosImageWidth];
		int hv_height = (*om)[CST_PosImageHeigh];
...
{
	int hv_width = UCI::OPTIONS[CST_PosImageWidth];
	int hv_height = UCI::OPTIONS[CST_PosImageHeigh];
