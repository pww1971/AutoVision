...
namespace UCI {
	...
	void stElement::initOptionMapMATCH(OptionsMap & o)
	{
		...
		o["变形最小尺度设置"] << Option("ScaleMin", 0.9f, 0.5f,1.0f,                                        // FindShapeModleMinScore
			"Default value: 0.9 Suggested values : 0.5, 0.6, 0.7, 0.8, 0.9, 1.0");
		o["变形最大尺度设置"] << Option("ScaleMax", 1.1f,1.0f,1.5f,                                         // FindShapeModleMinScore
			"Default value: 1.1 Suggested values : 1.0, 1.1, 1.2, 1.3, 1.4, 1.5");
		o["变形步数设置"] << Option("ScaleStep", "auto",                                         // FindShapeModleMinScore
