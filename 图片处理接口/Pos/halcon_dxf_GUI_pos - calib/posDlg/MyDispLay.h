...
#include"MyData.h"
#include <list>
void disp_3d_coord_system(HalconCpp::HWindow* hv_WindowHandle, HalconCpp::HTuple hv_CamParam, HalconCpp::HTuple hv_Pose,
	HalconCpp::HTuple hv_CoordAxesLength);
...
struct S_Model
{
	...
	HalconCpp::HTuple m_dxfModel, hv_CamParam, hv_ReferencePose;//模型id，相机的内参和姿态
	HalconCpp::HObject ho_ModelContours;//模型轮廓
	HalconCpp::HTuple hv_CentX, hv_CentY;//模型的两个交叉线 用来计算2d的旋转角
...
public:
	...
	void CreatDxfModel(UCI::OptionsMap* o, CString  dxffile);
