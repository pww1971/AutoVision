...
void ST_MYDISP::DisOnMeaEleEllispe()
{
	...
	//CImage myImage;
	//myImage.Load("H:\\IMG_2591.jpg");          //加载图片
	...
	//myImage.Save("H:\\IMG_2591-1.jpg", ImageFormatJPEG);
	...
	//1 Image  image("D:\\pic\\abc.jpg");          //加载图片
	...
	//4  WCHAR string[] = "姓名";                   //要写的字
	//5  FontFamily fontFamily("楷体");
	...
	//13  CLSID pngClsid;
	//14  GetEncoderClsid("image/jpeg", &pngClsid);
	//15  image.Save("D:\\pic\\abc_1.jpg", &pngClsid, NULL);//保存添加了汉字的图像
